...
root = Tk()
root.title("Contact Information by Sairoden Gandarosa")
...
# METHODS
def Exit():
    wayOut = tkinter.messagebox.askyesno("Contact Information", "Do you want to exit the system")
    if wayOut > 0:
        root.destroy()
        return
...
# LABELS
lbl_title = Label(Top,  text="Contact Information", bd=12, relief=GROOVE, fg="Black", bg="blue",
